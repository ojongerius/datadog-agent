...
//go:generate go run github.com/DataDog/datadog-agent/pkg/security/secl/generators/accessors -tags linux -doc -output ../../../docs/cloud-workload-security/secl.json
