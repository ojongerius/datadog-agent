...
func (z *TracerInfo) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 7
	// write "RuntimeId"
	err = en.Append(0x87, 0xa9, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x49, 0x64)
	if err != nil {
		return
	}
...
func (z *TracerInfo) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 7
	// string "RuntimeId"
	o = append(o, 0x87, 0xa9, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x49, 0x64)
...
func (z *TracerInfo) Msgsize() (s int) {
	s = 1 + 10 + msgp.StringPrefixSize + len(z.RuntimeId) + 10 + msgp.StringPrefixSize + len(z.ServiceId) + 4 + msgp.StringPrefixSize + len(z.Env) + 8 + msgp.StringPrefixSize + len(z.Version) + 21 + 1 + 17 + msgp.BytesPrefixSize + len(z.XXX_unrecognized) + 14 + msgp.Int32Size
	return
}
