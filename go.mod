...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.33.0-rc.1
	github.com/DataDog/datadog-agent/pkg/quantile v0.33.0-rc.1
	github.com/DataDog/datadog-agent/pkg/security/secl v0.33.0-rc.1
	github.com/DataDog/datadog-agent/pkg/util/log v0.33.0-rc.1
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.33.0-rc.1
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.33.0-rc.1
