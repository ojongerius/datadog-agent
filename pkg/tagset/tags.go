...
// MarshalJSON marshals the tag set as a JSON array.
func (tags *Tags) MarshalJSON() ([]byte, error) {
	// TODO
	return nil, fmt.Errorf("Not implemented")
}

// MarshalYAML marshals the tag set as a YAML array.
func (tags *Tags) MarshalYAML() ([]byte, error) {
	// TODO: is this even the right API
	return nil, fmt.Errorf("Not implemented")
}
